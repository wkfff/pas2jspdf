...
type
  ...
  public
    ...
    function line(x1: Double = 0.0; y1: Double = 0.0; x2: Double = 0.0;
      y2: Double = 0.0): TjsPDF;
    ...
    function output(
      ...
      options: TJSObject = nil): TjsPDF; overload;
    function output2(const &type: string;
      options: TJSObject = nil): string; overload; external name 'output';
    ...
    function setCharSpace(charSpace: Double): TjsPDF;
    { }
    ...
    function setDisplayMode(
      ...
      const pmode: string = ''): TjsPDF; overload;
    function setDisplayMode(const zoom: string; const layout: string;
      const pmode: string): TjsPDF; overload;
    ...
    function setDrawColor(
      ...
      ch3: Double = 0.0;
      { Color channel value. }
      ch4: Double = 0.0): TjsPDF; overload;
    function setDrawColor(const ch1: string = ''; const ch2: string = '';
      const ch3: string = ''; const ch4: string = ''): TjsPDF; overload;
    { }
    function setFileId(
      { GUID. }
    ...
    function setFillColor(
      ...
      { Color channel value. }
      ch4: Double = 0.0): TjsPDF; overload;
    function setFillColor(const ch1: string = ''; const ch2: string = '';
      const ch3: string = ''; const ch4: string = ''): TjsPDF; overload;
    ...
    function setLineCap(
      ...
      const style: string): TjsPDF; overload;
    function setLineCap(style: Double): TjsPDF; overload;
    ...
    function setTextColor(
      ...
      { Color channel value. }
      ch4: Double = 0.0): TjsPDF; overload;
    function setTextColor(const ch1: string = ''; const ch2: string = '';
      const ch3: string = ''; const ch4: string = ''): TjsPDF; overload;
    ...
    function text(
      ...
      options: JSValue = nil): TjsPDF; overload;
    function text(const text: array of string; x: Double = 0.0; y: Double = 0.0;
      options: JSValue = nil): TjsPDF; overload;
    function text(const text: string; x: JSValue = nil;
      y: JSValue = nil): TjsPDF; overload; varargs;
